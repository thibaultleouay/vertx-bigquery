package io.vertx.kotlin.bigquery
...
fun BigQueryOptions(
  ...
  googleCredentialToken: String? = null,
  ...
  verifyHost: Boolean? = null): BigQueryOptions = io.vertx.bigquery.BigQueryOptions().apply {
  ...
  if (googleCredentialToken != null) {
    this.setGoogleCredentialToken(googleCredentialToken)
  }
