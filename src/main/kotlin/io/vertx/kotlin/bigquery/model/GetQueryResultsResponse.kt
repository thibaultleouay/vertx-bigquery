...
/**
 * A function providing a DSL for building [io.vertx.bigquery.model.GetQueryResultsResponse] objects.
 *
 ...
 * @param jobReference  Reference to the BigQuery Job that was created to run the query. This field will be present even if the original request timed out, in which case GetQueryResults can be used to read the results once the query has completed. Since this API only returns the first page of results, subsequent pages can be fetched via the same mechanism (GetQueryResults).
 ...
 * @param rows  An object with as many results as can be contained within the maximum permitted reply size. To get any additional rows, you can call GetQueryResults and specify the jobReference returned above. Present only when the query completes successfully.
 ...
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [io.vertx.bigquery.model.GetQueryResultsResponse original] using Vert.x codegen.
 */
fun GetQueryResultsResponse(
  ...
  totalBytesProcessed: Long? = null): GetQueryResultsResponse = io.vertx.bigquery.model.GetQueryResultsResponse(io.vertx.core.json.JsonObject()).apply {
